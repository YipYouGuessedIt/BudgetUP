<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPost.aspx.cs" Inherits="PresentationTier.Views.ViewPost" %>
...
<body>
    ...
    <div>
        ...
        <div class="contentArea"><br />
            <h1 id="heaserarea" runat="server">Post Level</h1><hr />
            ...
            <div class="Incomesection">
                ...
                <div id="IncomeorExpenseAdd">
                    <br /><br />
                    <p>Click add to add a new post.Click back to go back to settings</p>
                    ...
                    <div runat="server" id="lister">
			            <div id="bl">
                            <h3>Post</h3>
                            <p>Below is a list of all the posts on the system</p>
