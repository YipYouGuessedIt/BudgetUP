<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditTitle.aspx.cs" Inherits="PresentationTier.Views.EditTitle" %>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div id="Add" class="contentArea">
            <br />
            <h1>Edit Title</h1><hr />
            		<p>Fill in the fields and click the add button to edit the current Title.Note that all required fields are marked with a *.</p>
		<hr/>
            <br />
            <asp:label runat="server">Title Name*</asp:label>
            <br/>
            <asp:TextBox ID="FacultyDescription" runat="server" required CssClass="form-control"></asp:TextBox>
            <br />
