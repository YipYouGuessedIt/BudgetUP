    ...
    <form id="form1" runat="server">
            ...
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <asp:LinkButton runat="server" href="ObjectivesPage.aspx" CssClass=" navbar-brand btn btn-link "><span class="glyphicon glyphicon-menu-left"></span></asp:LinkButton><img class=" navbar-brand img-responsive img-rounded" style="padding: 0; border-radius: 0; margin-right: 2px; margin-left: 2px;" src="../Images/logo.png"></img><a class="navbar-brand" href="#">BudgetUP</a>
                    </div>
        ...
        <div id="normalnav" runat="server">
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <button type="button" href="ObjectivesPage.aspx" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
                            <span class="icon-bar"></span>
                            <span class="icon-bar"></span>
                            <span class="icon-bar"></span>
                        </button>
        ...
        <div id="AddObjectives" class="contentArea">
            ...
            <h1>Add Objective</h1>
            <hr />
            <p>Fill in the fields and click the add button to add a new Objective. Note that all required fields are marked with a *.</p>
            <hr />
            ...
            <asp:Button runat="server" CssClass="btn-info btn-lg btn" Text="Add" OnClick="Unnamed3_Click" /><br />
            <br />
        </div>
    </form>
