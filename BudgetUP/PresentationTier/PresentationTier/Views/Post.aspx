<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Post.aspx.cs" Inherits="PresentationTier.Views.Post" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="Add" class="contentArea">
            <br />
            <h1>Add Post</h1><hr />
            		<p>Fill in the fields and click the add button to edit the current post.Note that all required fields are marked with a *.</p>
		<hr/>
            <br />
