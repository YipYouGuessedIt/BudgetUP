<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonationActivity.aspx.cs" Inherits="PresentationTier.Views.DonationActivity" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Add" class="contentArea">
            <br />
            <h1>Donations, in-kind support and pledges</h1>
            <hr />
            <p>Fill in the fields and click the add button to add a new  donations, in-kind support or pledge. Note that all required fields are marked with a *.</p>
            <hr />
            <asp:Label runat="server" Font-Bold="True">Name of donor/funding agency*</asp:Label><asp:TextBox runat="server" ID="name" required name="name" CssClass="form-control" MaxLength="199"></asp:TextBox><br />
