...
{
    public partial class ViewTitles : System.Web.UI.Page
    {
            ...
            protected void Eclicker(object sender, EventArgs e)
        {
            ...
            char[] ma = "Title".ToCharArray();
            Session["TitlesID"] = m.ID.Split(ma)[0];
            Response.Redirect("EditTitle.aspx");
                }
            catch (Exception err)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                tree.InnerHtml = "<a href='ProjectsPage.aspx'>Projects</a>  &gt <a href='Settings.aspx'>Settings</a>  &gt View Titles";
