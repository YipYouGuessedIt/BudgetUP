<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTitles.aspx.cs" Inherits="PresentationTier.Views.ViewTitles" %>
        ...
        <div class="contentArea"><br />
            ...
            <div class="Incomesection">
                <div id="IncomeorExpenseSearch">
                    		<h2>Search</h2>
                    <p>type in here to filter the list of titles</p>
                ...
                <div id="IncomeorExpenseAdd">
                    ...
                    <div runat="server" id="lister">
			            <div id="bl">
                            <h3>Faculty</h3>
                            <p>Below are a list of the Titles on the system</p>
