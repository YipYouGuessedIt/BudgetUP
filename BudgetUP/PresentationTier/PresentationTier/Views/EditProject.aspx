  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
           <asp:Button runat="server" CssClass="btn-info btn" Text="Delete" OnClick="AddProject_Click2" ID="Button1" />
      ...
      <div class="modal-footer">
        ...
        <div id="tree" runat="server" class="treeView">
            ...
            <div id="AddProjects" class="contentArea"><br />
                <h1>Project</h1><hr />
                <asp:Label runat="server" Font-Bold="True">Project Title*</asp:Label><asp:TextBox autofocus runat="server" ID="title" required name="title" CssClass="form-control" MaxLength="199"></asp:TextBox><br />
                <asp:Label runat="server" Font-Bold="True">Overall Goal of the Project *</asp:Label><asp:TextBox required runat="server" ID="goal" name="goal" CssClass="form-control" MaxLength="199"></asp:TextBox><br />
