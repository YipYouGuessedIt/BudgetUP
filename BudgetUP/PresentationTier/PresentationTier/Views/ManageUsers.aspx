    ...
    <div>
        ...
        <div class="contentArea"><br />
            ...
            <div id="ProjectSearch">
				...
				<input class="form-control" placeholder="Search Users..." /><asp:Button ID="Button1" runat="server" CssClass="btn-info btn-lg btn" Text="Search" OnClick="Button1_Click" /><br />
			</div>
			...
			<div id="ProjectList" class="list-group">
                <div runat="server" id="lister">
                     ...
                     <p>Below is a list of all the Users on the system.Click to view</p>
