<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditDomain.aspx.cs" Inherits="PresentationTier.Views.EditDomain" %>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div id="Add" class="contentArea">
            <br />
            <h1>Edit Domain</h1><hr />
            		<p>Fill in the fields and click the add button to edit the current email domain.Note that all required fields are marked with a *.</p>
		<hr/>
            <br />
            <asp:label runat="server" Font-Bold="True">Domain Name*</asp:label>
            <br/>
            <asp:TextBox ID="FacultyDescription" runat="server" required CssClass="form-control" OnTextChanged="FacultyDescription_TextChanged" MaxLength="100"></asp:TextBox>
            <br />
