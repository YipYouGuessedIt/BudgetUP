...
<body>
    ...
    <form id="form1" runat="server">
		...
		<hr/>
            <br />
            <asp:label runat="server">Domain Name*</asp:label>
            <br/>
            <asp:TextBox ID="FacultyDescription" runat="server" required CssClass="form-control" OnTextChanged="FacultyDescription_TextChanged"></asp:TextBox>
            <br />
