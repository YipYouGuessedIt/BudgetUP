<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceProviderActivity.aspx.cs" Inherits="PresentationTier.Views.ServiceProviderActivity" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Add" class="contentArea">
            <br />
            <h1>External Service Provider</h1>
            <hr />
            ...
            <asp:Label runat="server">Amount (in Rands)*</asp:Label><asp:TextBox required runat="server" min="0" ID="amount" type="number" name="amount" CssClass="form-control"></asp:TextBox><br />
            ...
            <asp:Button runat="server" CssClass="btn-info btn-lg btn" Text="Add" OnClick="Unnamed_Click" /><br />
            <br />
        </div>
    </form>
