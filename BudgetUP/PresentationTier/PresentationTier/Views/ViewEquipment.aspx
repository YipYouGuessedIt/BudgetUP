  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<hr/>
                <asp:Label runat="server" Font-Bold="True">Name of Equipment*</asp:Label><asp:TextBox runat="server" ID="name" required name="name" CssClass="form-control"></asp:TextBox><br />
                <asp:Label runat="server" Font-Bold="True">Quoted Amount*</asp:Label><asp:TextBox  runat="server" ID="amount" name="amount" CssClass="form-control"></asp:TextBox><br />
