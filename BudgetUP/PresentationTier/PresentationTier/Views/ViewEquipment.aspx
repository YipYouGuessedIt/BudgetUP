    ...
    <body>        
        ...
        <form id="form1" runat="server">
            ...
            <div id="Add" class="contentArea"><br />
                <h1>Equipment</h1><hr />
                		<p>Fill in the fields and click the save button to edit the current Equipment.Note that all required fields are marked with a *.</p>
		<hr/>
                ...
                <asp:Label runat="server">Quoted Amount*</asp:Label><asp:TextBox  runat="server" ID="amount" name="amount" CssClass="form-control"></asp:TextBox><br />
                <asp:Label runat="server">Notes/Extra Description*</asp:Label><asp:TextBox TextMode="multiline" Columns="50" Rows="5"  required runat="server" ID="note" name="note" CssClass="form-control"></asp:TextBox><br />
