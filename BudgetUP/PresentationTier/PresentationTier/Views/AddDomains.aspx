<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDomains.aspx.cs" Inherits="PresentationTier.Views.AddDomains" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Add" class="contentArea">
            ...
            <h1>Add Domain</h1>
            <hr />
            <p>Fill in the fields and click the add button to add a new email domain. Note that all required fields are marked with a *.</p>
            <hr />
            <br />
            ...
            <br />
            <asp:Button runat="server" CssClass="btn-info btn-lg btn" Text="Add" OnClick="addRole" /><br />
            <br />
        </div>
    </form>
</body>
