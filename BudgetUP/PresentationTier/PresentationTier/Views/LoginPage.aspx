  ...
  <div class="modal-dialog">
    ...
    <div>
             ...
             <div id="AddProjects" class="contentArea"><br />
                ...
                <asp:Button runat="server" CssClass="btn-info btn-lg btn" Text="Login" OnClick="Unnamed3_Click" /><asp:HyperLink CssClass="frgt" runat="server" NavigateUrl="~/Views/ForgotPassword.aspx" ToolTip="Recover lost password">Forgot Password?</asp:HyperLink>
                 <br /><br />
            </div>
