...
<head runat="server">
    <title>View Operational expense</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Add" class="contentArea">
            ...
            <hr />
            <p>Fill in the fields and click the add button to edit the current operation cost. Note that all required fields are marked with a *.</p>
            <hr />
            <asp:Label runat="server" Font-Bold="True">Operation Type*</asp:Label>
            <br />
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" OnInit="DropDownList1_Init">
            </asp:DropDownList>
            <br />
            <asp:Label runat="server" Font-Bold="True">Quantity*</asp:Label><asp:TextBox min="0" required type="number" runat="server" ID="quantity" name="quantity" CssClass="form-control"></asp:TextBox><br />
