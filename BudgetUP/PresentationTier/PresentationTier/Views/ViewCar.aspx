    ...
    <form id="form1" runat="server">
        ...
        <div id="Add" class="contentArea">
            ...
            <div id="days" runat="server">
                <asp:Label runat="server" Font-Bold="True">     Days*</asp:Label><asp:TextBox min="0" required type="number" runat="server" ID="quantity" name="quantity" CssClass="form-control">0</asp:TextBox><br />
            </div>
            <div id="kml" runat="server">
                <asp:Label runat="server" Font-Bold="True" > Kilometers*</asp:Label><asp:TextBox required min="0" type="number" runat="server" ID="TextBox1" name="quantity" CssClass="form-control">0</asp:TextBox><br />
            </div>
