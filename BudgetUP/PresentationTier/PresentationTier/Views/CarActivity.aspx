<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarActivity.aspx.cs" Inherits="PresentationTier.Views.CarActivity" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Add" class="contentArea">
            ...
            <div id="days">
                <asp:Label ID="dayslab" runat="server">     Days*</asp:Label><asp:TextBox required min="0" type="number" runat="server" ID="quantity" name="quantity" CssClass="form-control">0</asp:TextBox><br />
            </div>
            <div id="kml">
                <asp:Label ID="kmlab" runat="server"> Kilometers*</asp:Label><asp:TextBox required type="number" min="0" runat="server" ID="TextBox1" name="quantity" CssClass="form-control">0</asp:TextBox><br />
            </div>
            ...
            <asp:Button runat="server" CssClass="btn-info btn-lg btn" Text="Add" OnClick="Unnamed5_Click" /><br />
            <br />
        </div>
    </form>
