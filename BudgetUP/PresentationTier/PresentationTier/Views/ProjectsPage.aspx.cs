    ...
    public partial class ProjectsPage : System.Web.UI.Page
    {
        ...
        protected void addtoProjectLists()
        {
            ...
            using (var dbContext = new dboEntities())
            {
                ...
                if(m == false)
                {
                    Div1.InnerHtml = "<p>Welcome " + this.Session["userTitle"] + " " + this.Session["userSname"] + ", this is your gateway to manage your project budgets. Click on the button below to add project budgets. Above are buttons that will allow you to download the report for the project you are in as well as submit the report to DRIS.</p>";
                }
                else
                {
                    Div1.InnerHtml = "<p>Welcome " + this.Session["userTitle"] + " " + this.Session["userSname"] + ", this is your gateway to manage your project budgets. Below is a list of all the projects you created. Click on a project item to manage it. Above are buttons that will allow you to download the report for the project you are in as well as submit the report to DRIS.</p>";
